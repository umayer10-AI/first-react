  ...
  return (
    <div className='max-w-[90%] mx-auto grid grid-cols-1 lg:grid-cols-2 my-4'>
        ...
        <div className='flex justify-end items-end'>
            <img className='w-[80%] h-[80%] object-cover rounded-2xl' src="https://plus.unsplash.com/premium_photo-1682309543429-6aaa6d792dae?q=80&w=1212&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
        </div>
    </div>
  )
}
